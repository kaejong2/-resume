...
class Arguments:
    def __init__(self):
        ...
        self._parser.add_argument('--num_epochs', type=int, default=100, help='Number of epochs of training.')
        self._parser.add_argument('--data_path', type=str, default='/mnt/hdd/jongjin/data/data/facades/', help='Dataset path.')
        ...
        self._parser.add_argument('--data_path', type=str, default='../Data/', help='Checkpoint path.')
        self._parser.add_argument('--ckpt_path', type=str, default='../ckpt/', help='Checkpoint path.')
        self._parser.add_argument('--load_ckpt', type=str, default='../ckpt/', help='Checkpoint path.')
        self._parser.add_argument('--result_path', type=str, default='../result', help='Generated results path.')
